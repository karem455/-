...
if (isset($_POST['save'])) {
    ...
    header('Location: http://' . $_SERVER['HTTP_HOST'] . '/Prescription-Management-System-master/Prescription-Management-System-master/prescription.php?id=' . $patient_id . '');
}
...
<div class="container">
    ...
    <div class="container">
        ...
        <div role="tabpanel" class="tab-pane active" id="newPrescription">
  <!-- Content of the "New Prescription" tab goes here -->
</div>
<div role="tabpanel" class="tab-pane" id="oldPrescription">
  <!-- Content of the "Prescription History" tab goes here -->
</div>
  <li role="presentation" class="active">
    <a href="#newPrescription" aria-controls="newPrescription" role="tab" data-toggle="tab">New Prescription</a>
  </li>
  <li role="presentation">
    <a href="#oldPrescription" aria-controls="oldPrescription" role="tab" data-toggle="tab">Prescription History</a>
  </li>
</ul>
                    ...
                    <div class="row" style="background-color:#d7ffe0;">
                        <div class="container">
                            ...
                            <div class="col-sm-5 text-right">
                                ...
                                <h5>
                                    <h4> Professor Dr.mohamed </h4>

                                    <p> dctor, , Phd ( London ) </p>
                                    <p><b>Expertise:</b> Pediatric - Child </p>
                                    <p><b>work:</b> Central Hospital Limited </p>
                                </h5>
            ...
            <div role="tabpanel" class="tab-pane fade" id="oldPrescription">
                ...
                <div class="row">
                    ...
                    <div class="container panel panel-info" style="background-color:#d7ffe0;">
                        ...
                        <center> <button class="btn btn-success " onclick="myFunction()">Print Prescription</button> </center>
